...
namespace Tabtale.Editor.PSDK {
	public static class PsdkBuildMultidexPsdkMenu {
		...
		static void BuildMultyDexedAPK(){
			...
			#endif
			LogAndExitOnError( BuildPipeline.BuildPlayer( ScenesNames(), OutputFilePath() + "_project", BuildTarget.Android, _buildOptions));
		}
		...
		static string OutputFilePath() {
			...
			if (_gameName == "")
				_gameName = PlayerSettings.bundleIdentifier;
