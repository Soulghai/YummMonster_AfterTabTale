...
public class UpdateFromTTAppsDB : MonoBehaviour {
	...
	const string TESTING_DOMAIN = "tt-apptesting-gatewayzuul.elasticbeanstalk.com";
	...
	static void updateFiles(string domain) {
		...
		foreach (string store in stores) {
			...
			string json = getConfigJsonFromUrl(store,PlayerSettings.bundleIdentifier,domain);
			if (json == null) {
