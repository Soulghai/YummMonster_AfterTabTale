...
extern "C" {
    ...
    {
        NSString *sPrice =[[NSString alloc] initWithUTF8String:price];
        NSString *sCurrency =[[NSString alloc] initWithUTF8String:currency];
        NSString *sProductId =[[NSString alloc] initWithUTF8String:productId];
