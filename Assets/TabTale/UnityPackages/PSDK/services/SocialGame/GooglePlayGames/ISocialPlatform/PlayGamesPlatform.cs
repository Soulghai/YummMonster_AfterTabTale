...
namespace GooglePlayGames
{
    ...
    public class PlayGamesPlatform : ISocialPlatform
    {
        ...
        public void Authenticate(Action<bool> callback, bool silent)
        {
            ...
            // authenticate!
			mClient.Authenticate(callback, silent, signOutCallbacks);//Tabtale change
        }

		/**
         * Tabtale change
         */
		private static Action signOutCallbacks;
		public static void RegisterSignOutCallback(Action signOutCallback) 
		{
			signOutCallbacks += signOutCallback;
		}
