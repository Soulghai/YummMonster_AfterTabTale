...
namespace GooglePlayGames
{
    ...
    public static class GPGSUtil
    {
		...
		#region TABTALE FIX
		private const string GameInfoPath = "Assets/TabTale/UnityPackages/PSDK/services/SocialGame/GooglePlayGames/GameInfo.cs";
		#endregion 
        ...
        {
			return ReadFile(SlashesToPlatformSeparator("Assets/TabTale/UnityPackages/PSDK/services/SocialGame/GooglePlayGames/Editor/" + name + ".txt"));
        }
        ...
        {
			// no need to copy support libs, if psdk already exists.
			return;
            ...
            string supportJarDest =
				GPGSUtil.SlashesToPlatformSeparator("Assets/TabTale/UnityPackages/PSDK/services/SocialGame/Plugins/Android/libs/android-support-v4.jar");
            ...
            string libProjDestDir = GPGSUtil.SlashesToPlatformSeparator(
				"Assets/TabTale/UnityPackages/PSDK/services/SocialGame/Plugins/Android/google-play-services_lib");
			...
			GPGSUtil.EnsureDirExists("Assets/TabTale/UnityPackages/PSDK/services/SocialGame/Plugins");
			GPGSUtil.EnsureDirExists("Assets/TabTale/UnityPackages/PSDK/services/SocialGame/Plugins/Android");
        ...
        public static void GenerateAndroidManifest(bool needTokenPermissions)
        {
            string destFilename = GPGSUtil.SlashesToPlatformSeparator(
				"Assets/TabTale/UnityPackages/PSDK/services/SocialGame/Plugins/Android/MainLibProj/AndroidManifest.xml");
            ...
            TabTale.UnityPackages.PSDK.SocialGame.Editor.PSDK_GPGSUtils.CompressMainLibProjToAAR ();
        }
