...
namespace GooglePlayGames.Native
{
    ...
    public class NativeClient : IPlayGamesClient
    {
		...
		* Tabtale change
        */
		private volatile Action mOnSignOutCallback = ()=>{};
        ...
        public void Authenticate(Action<bool> callback, bool silent, Action signOutCallback)
        {
            lock (AuthStateLock)
            {
				...
				{
					mOnSignOutCallback = signOutCallback;
				}
            }
        ...
        private void ToUnauthenticated()
        {
            lock (AuthStateLock)
            {
                ...
                mAchievements = null;
                mAuthState = AuthState.Unauthenticated;
				PlayGamesHelperObject.RunOnGameThread(mOnSignOutCallback); //Tabtale change
                mAuthGeneration++;
            }
        }
